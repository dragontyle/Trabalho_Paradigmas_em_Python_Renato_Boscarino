...
somaquadrados = 0
# For para realizar a criação da lista para digitação dos 10 números inteiros e in para realizar se está dentro do for e realizar a soma dos quadrados dos números inteiros
for i in range(10):
